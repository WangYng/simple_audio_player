...
public interface SimpleAudioPlayerApi {
    ...
    static void setup(FlutterPlugin.FlutterPluginBinding binding, SimpleAudioPlayerApi api, Context context) {
        ...
        {
            BasicMessageChannel<Object> channel = new BasicMessageChannel<>(binaryMessenger, "io.github.wangyng.simple_audio_player.setPlaybackRate", new StandardMessageCodec());
            if (api != null) {
                channel.setMessageHandler((message, reply) -> {
                    Map<String, Object> wrapped = new HashMap<>();
                    try {
