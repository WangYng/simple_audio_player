...
class SimpleAudioPlayerApi {
  ...
  static Future<void> setPlaybackRate({required int playerId, required double playbackRate}) async {
    const channel = BasicMessageChannel<dynamic>('io.github.wangyng.simple_audio_player.setPlaybackRate', StandardMessageCodec());

    final Map<String, dynamic> requestMap = {};
    requestMap["playerId"] = playerId;
    requestMap["playbackRate"] = playbackRate;
    final reply = await channel.send(requestMap);
  ...
  static Future<double> getPlaybackRate({required int playerId}) async {
    const channel = BasicMessageChannel<dynamic>('io.github.wangyng.simple_audio_player.getPlaybackRate', StandardMessageCodec());
